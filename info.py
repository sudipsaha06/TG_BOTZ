...
API_ID = int(environ.get('API_ID', '12596147'))
API_HASH = environ.get('API_HASH', '376d2b9215aad81b9522afccd1067786')
BOT_TOKEN = environ.get('BOT_TOKEN', "6724053556:AAH1n6r2apf-oG98lBywLHdr6xn7dwamKnU")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5165943027 777170651').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5165943027 777170651').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vk:vkdatabase@cluster0.tnhlebr.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'nNmjBM0MTPVOkZugAxnQcNUkFQB2')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+8sg-tWwra544ZTE1')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello Nanbha and Nanbis ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001974015074'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+LpmXsrmPeb1jN2I1')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001763943446')).split()]
