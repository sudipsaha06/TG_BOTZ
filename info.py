...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5165943027').split()]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/main_channel_bot_update')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Netflix_Support_Group')
